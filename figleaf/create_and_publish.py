...
if __name__ == "__main__":  
        ...
        for neuron, neuron_id in neurons_dict.items():
            ...
            if upload_files.lower() == "y":
                ...
                if os.path.isfile(pathy):
                    ...
                    print ("files do not exist!", pathy)
    ...
    if doi.lower() == "n":
        print("Not reserving doi.")
    if make_articles.lower() == "n":
        print("Not making an article.")
